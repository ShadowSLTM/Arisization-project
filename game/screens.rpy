...
screen success(): 
    ...
    use game_menu(_("Succès"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Affection pour les autres : [quest18]/1\n")
            text _("Entre connaissances : [quest19]/1\n")
            text _("le bon présumé : [quest20]/1\n")
            text _("Affection pour les autres partie 2 : [quest21]/1\n")
            text _("Plus c’est gros plus ça passe : [quest22]/1\n")
            text _("La vérité avant tout : [quest23]/1\n")
            text _("Génie des maths : [quest24]/1\n") 
            text _("Petit exercice de Runix : [quest25]/1\n") 
            text _("Seconde mise à jour : [quest26]/1\n")
            text _("Génie de l’informatique : [quest27]/1\n")
            text _("Détail du passé : [quest28]/1\n")
            text _("Mentir n’est pas si mal : [quest29]/1\n")
            text _("Journalistes de merde : [quest30]/1\n")
            text _("Dire les termes : [quest31]/1\n")           
            text _("Silence brutal : [quest32]/1\n") 
            text _("Molière c'est toi ? : [quest33]/1\n") 
            text _("Jamais deux sans trois : [quest34]/1\n")  
            text _("Sa vraie valeur : [quest35]/1\n") 
            text _("Faire de la philosophie : [quest36]/1\n") 
            text _("Bon philosophe : [quest37]/1\n") 
            text _("L'entraide scolaire : [quest38]/1\n") 
